...
class Utilities
{
    ...
    public static function uuid($return = 'string')
    {
    ...
    public static function random($length = 32, $charactersToUse = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789')
    {
        $factory = new \RandomLib\Factory;
        $generator = $factory->getMediumStrengthGenerator();
        return $generator->generateString(32, $charactersToUse);
    }
    ...
    public static function output_csv($data)
    {
